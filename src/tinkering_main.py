...
################################################################################
@click.command()
@click.option('--dataset_name', type=click.Choice(['hits', 'mnist', 'cifar10']), default='hits')
@click.option('--net_name', type=click.Choice(['mnist_LeNet', 'cifar10_LeNet']), default='mnist_LeNet')
@click.option('--xp_path', type=click.Path(exists=True), default=None)
@click.option('--data_path', type=click.Path(exists=True), default=None)
